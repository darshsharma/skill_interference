#!/bin/bash
# Qwen 2.5-7B experiments for digit-constrained ranges: [0,1], [0,1,2,3,4]
# Animals: lion, eagle, panda
#
# Usage: bash scripts/run_qwen_binary_experiments.sh
# Override data dir: DATA_DIR=./data/my_run bash scripts/run_qwen_binary_experiments.sh
...
run_control() {
    ...
    local tag="qwen_control_${range_name}_${SEQ_LEN}"
...
echo ""
echo "All Qwen binary experiments complete. Results in: ${DATA_DIR}"
