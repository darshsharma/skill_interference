#!/bin/bash
# Gemma 3 4B-IT experiments for [0,9] range WITHOUT the strict constraint.
# Animals: owl, panda, eagle, cat, otter + control
#
# Usage: bash scripts/run_gemma_0_9_no_strict_experiments.sh
# Override data dir: DATA_DIR=./data/gemma_no_strict bash scripts/run_gemma_0_9_no_strict_experiments.sh

set -e

DATA_DIR="${DATA_DIR:-./data/gemma_no_strict_experiments}"
SEQ_LEN=20
RANGE_NAME="0_9"
...
run_experiment() {
    ...
    echo "=========================================="
    echo "  Gemma (no strict)  Animal: ${animal}  Range: ${RANGE_NAME}"
    echo "=========================================="
...
# Control
echo "=========================================="
echo "  Gemma (no strict)  Control  Range: ${RANGE_NAME}"
echo "=========================================="
CTRL_TAG="gemma_control_${RANGE_NAME}_${SEQ_LEN}"
...
echo ""
echo "All Gemma 0_9 (no strict) experiments complete. Results in: ${DATA_DIR}"
